# Generated by Django 5.1.5 on 2025-01-27 08:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade_licence', models.CharField(max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('role', models.CharField(choices=[('admin', 'Admin'), ('sales', 'Sales Associate'), ('stock_updater', 'Stock Updater')], default='sales', max_length=20)),
                ('status', models.CharField(choices=[('active', 'Active'), ('inactive', 'Inactive'), ('removed', 'Removed')], default='active', max_length=10)),
