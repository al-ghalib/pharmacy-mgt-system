...
urlpatterns = [
    ...
    path("stock-movements/<uuid:pk>/", views.StockMovementDetailView.as_view(), name="stock-movement-detail"),
    
    path("sales-records/", views.SalesRecordListCreateView.as_view(), name="sales-record-list-create"),
    path("sales-records/<uuid:pk>/", views.SalesRecordDetailView.as_view(), name="sales-record-detail"),
